...
data class SyncBackendState(
    val selectedBackend: SyncBackendConfig = SyncBackendDefaults.default(),
...
object SyncBackendDefaults {
    ...
    fun default(): SyncBackendConfig =
        hosted().takeIf { it.isUsableClientConfig() } ?: nuvio()
...
internal fun SyncBackendManifest.backendConfigForActiveBackend(): SyncBackendConfig? {
    ...
    return SyncBackendDefaults.byId(activeBackend)
